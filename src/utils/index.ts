...
export const captureSnapshot = (video: HTMLVideoElement, time: number): Promise<string> => {
...
export const generateTheme = async (imageURI: string, setError: (error: string) => void) => {
    await sleep(200);
...
export const generateOrchestralBrief = async (theme: string, setError: (error: string) => void) => {
    await sleep(200);
...
export const generateMusic = async (theme: string, duration: number,setError: (error: string) => void) => {
    await sleep(200);
